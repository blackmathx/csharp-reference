...
class _I_EF
{
    /*
            ...
            EF is built on top of ADO.NET. EF internally uses ADO.NET (SqlConnection, SqlCommand, etc.) to talk to the database, but abstracts that away from the developer.
                
            LINQ is a core part of Entity Framework. With LINQ to Entities, you can write queries like:
