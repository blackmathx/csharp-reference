...
namespace CSharp_Reference
{
    internal class _D_Arrays
    {
        public static void runner()
        {
            ...
            foreach (var item in intArray) // Using foreach to iterate
            {
                Console.Write(item + " ");
            }
            Console.WriteLine();
            ...
            for (int i = 0; i < stringArray.Length; i++) // Using for loop
            {
            ...
            int[] convertedArray = Array.ConvertAll(numberStrings, int.Parse); // Convert strings to integers
